    ...
    <div className="space-y-6">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h1 className="text-xl font-black text-white flex items-center gap-2">
                ...
                <span className="text-[10px] font-extrabold px-2 py-0.5 rounded bg-cyan-950 text-cyan-400 border border-cyan-800">
                  INSIGHTS AI 4.0
                </span>
              </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredPredictions.map(pred => (
          <div 
            key={pred.id} 
            className="glass-panel glass-panel-hover p-5 rounded-2xl border border-slate-800 space-y-4 relative overflow-hidden flex flex-col justify-between"
          >
            ...
            <div className="flex items-start justify-between">
              <div>
                ...
                <h3 className="font-extrabold text-base text-white mt-0.5">{pred.title}</h3>
              </div>
            ...
            <div className="p-4 rounded-xl bg-slate-900/90 border border-slate-800 flex items-center justify-between">
              <div>
                <div className="text-[10px] uppercase font-bold text-slate-400">PROBABILITY RISK</div>
                <div className="text-3xl font-black text-rose-400">{pred.risk_percentage}%</div>
              </div>
              <div className="text-right">
                ...
                <div className="text-lg font-bold text-cyan-400 flex items-center gap-1">
                  <Sparkles className="w-4 h-4 text-cyan-400" /> {pred.confidence}%
                </div>
              </div>
            </div>
            ...
            <div className="space-y-1">
              <div className="flex justify-between text-[11px] font-bold text-slate-400">
                ...
                <span className="text-rose-400">{pred.risk_percentage}% Threshold</span>
              </div>
            ...
            <div className="space-y-2 text-xs text-slate-300">
              <div className="flex items-start gap-2">
                ...
                <div>
                  <span className="font-bold text-slate-200">Affected Regions:</span>
                  <div className="text-slate-400 text-[11px]">{pred.affected_regions.join(', ')}</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  <span className="font-bold text-slate-200">Predicted Timeframe: </span>
                  <span className="text-amber-300 font-semibold">{pred.predicted_time}</span>
                </div>
              </div>
            </div>
