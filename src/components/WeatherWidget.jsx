...
export const WeatherWidget = () => {
  ...
  return (
    <div className="glass-panel rounded-2xl p-5 border border-slate-200 dark:border-slate-700/80 shadow-xl space-y-4 transition-colors duration-200">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
        <div className="flex items-center gap-2.5 shrink-0">
          ...
          <div>
            <h3 className="font-extrabold text-sm text-slate-900 dark:text-white">Live Meteorological Radar</h3>
            <p className="text-[11px] text-slate-500 dark:text-slate-400">Integrated IMD & OpenWeather Telemetry</p>
          </div>
        </div>

        {/* Region Selector Pills */}
        <div className="flex flex-wrap items-center gap-1.5 bg-slate-100 dark:bg-slate-900/80 p-1.5 rounded-xl border border-slate-200 dark:border-slate-800 text-xs w-full sm:w-auto">
      ...
      <div className={`p-3 rounded-xl border flex items-start gap-3 ${
        ...
        <div>
          ...
          <p className="text-xs text-slate-700 dark:text-slate-300 mt-0.5">{current.warning_message}</p>
        </div>
      </div>

      {/* Grid Metrics */}
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <div className="bg-slate-100 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 p-3 rounded-xl shadow-sm">
          ...
          <div className="font-black text-lg text-slate-900 dark:text-slate-100 mt-1">{current.temp}</div>
        </div>

        <div className="bg-slate-100 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 p-3 rounded-xl shadow-sm">
          <div className="text-[10px] text-slate-500 dark:text-slate-400 uppercase font-bold flex items-center gap-1">
            <CloudRain className="w-3.5 h-3.5 text-cyan-600 dark:text-cyan-400" /> Precipitation
          </div>
          <div className="font-black text-lg text-cyan-700 dark:text-cyan-300 mt-1">{current.rain_mm}</div>
        </div>
        ...
        <div className="bg-slate-100 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 p-3 rounded-xl shadow-sm">
          ...
          <div className="font-black text-lg text-amber-700 dark:text-amber-300 mt-1">{current.wind_kmh}</div>
        </div>

        <div className="bg-slate-100 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 p-3 rounded-xl shadow-sm">
          <div className="text-[10px] text-slate-500 dark:text-slate-400 uppercase font-bold flex items-center gap-1">
            <Droplets className="w-3.5 h-3.5 text-blue-500 dark:text-blue-400" /> Relative Humidity
          </div>
          <div className="font-black text-lg text-blue-700 dark:text-blue-300 mt-1">{current.humidity}</div>
        </div>
      </div>
    </div>
  );
